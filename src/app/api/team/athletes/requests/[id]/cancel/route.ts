...
import { AthleteRegistrationError, cancelTeamAthleteRequest } from '@/lib/athlete-registration'
...
export async function POST(
  ...
  try {
    ...
    const result = await cancelTeamAthleteRequest(
      sessionData.teamId,
      id,
    ...
    return NextResponse.json({ error: error.message || 'Erro ao cancelar solicitacao.' }, { status })
  }
}
