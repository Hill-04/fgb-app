...
export default async function AdminSettingsPage() {
  ...
  const sections = [
    {
      icon: Globe,
      title: 'Identidade da Federacao',
      description: 'Nome oficial, logo, contato publico e redes sociais',
      accent: 'border-t-[var(--verde)]',
      iconBg: 'bg-[var(--verde)]/10 text-[var(--verde)]',
      fields: [
        { label: 'Nome da Federacao', value: 'Federacao Gaucha de Basketball', type: 'text' },
    ...
    },
    {
      icon: Bell,
      title: 'Notificacoes',
      description: 'Configuracoes de envio de e-mails e alertas automaticos',
    ...
    },
    {
      icon: Shield,
      title: 'Seguranca',
      description: 'Controle de acesso e permissoes do sistema',
      accent: 'border-t-[var(--red)]',
      iconBg: 'bg-[var(--red)]/10 text-[var(--red)]',
      fields: [
        { label: 'Sessao maxima (horas)', value: '24', type: 'number' },
        { label: 'Dominios permitidos', value: 'fgbasket.com.br', type: 'text' },
      ],
    },
  ]
  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-6 duration-700 max-w-5xl">
      <div className="relative p-10 rounded-[32px] overflow-hidden bg-white border border-[var(--border)] shadow-sm">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <p className="fgb-label text-[var(--gray)]" style={{ fontSize: 9, letterSpacing: '0.2em' }}>GESTAO ESTRUTURAL</p>
              <h1 className="fgb-display text-4xl text-[var(--black)] mt-1">Configuracoes da Federacao</h1>
            </div>
          </div>
          <p className="fgb-label text-[var(--gray)] max-w-lg leading-relaxed" style={{ textTransform: 'none', letterSpacing: 0, opacity: 0.8 }}>
            Ajuste a identidade visual, parametros de comunicacao e regras de seguranca que governam todo o ecossistema FGB.
          </p>
        </div>
      </div>
      ...
      <div className="group relative p-6 rounded-[24px] bg-[#FFF8E6] border border-[#FFE08C] shadow-sm flex items-start gap-4 transition-all hover:shadow-md">
        ...
        <div>
          <h4 className="fgb-display text-base text-[#856404] mb-1">Configuracoes Criticas</h4>
          <p className="text-sm text-[#856404]/70 leading-snug">
            Estas definicoes afetam a integridade dos dados e o acesso dos usuarios. Qualquer mudanca aqui e refletida instantaneamente em todos os modulos.
          </p>
        </div>
      </div>
              ...
              <div className="px-10 pb-10">
                <div className="p-5 bg-[var(--gray-l)]/50 border border-dashed border-[var(--border)] rounded-[24px] text-center transition-all group-hover:bg-white group-hover:border-solid group-hover:border-[var(--border)]">
                  <p className="fgb-label text-[var(--gray)]" style={{ fontSize: 10, textTransform: 'none', letterSpacing: 0 }}>
                    <span className="font-bold text-[var(--black)]">Status:</span> Controle restrito ao suporte tecnico Nivel 3.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-[var(--black2)] rounded-[27px] p-7 flex items-center gap-6 relative">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              <p className="fgb-display text-lg text-white leading-none">Nucleo Central FGB</p>
