                      ...
                      <div key={game.id} className="grid gap-3 rounded-2xl border border-[var(--border)] bg-white px-5 py-4 shadow-sm md:grid-cols-[80px_110px_1fr_130px_120px_64px] md:items-center">
                        ...
                        <details className="relative">
                          ...
                          <div className="absolute right-0 z-20 mt-2 flex w-64 flex-col rounded-2xl border border-[var(--border)] bg-white p-2 shadow-xl">
                            <Link href={buildAdminGamePath(game.id, 'roster', championshipId)} className="flex items-center gap-2 rounded-xl px-3 py-2 text-left text-sm text-[var(--black)] hover:bg-[var(--gray-l)]"><RotateCcw className="h-4 w-4" />Pré-jogo oficial</Link>
                            <Link href={buildAdminGamePath(game.id, 'live', championshipId)} className="flex items-center gap-2 rounded-xl px-3 py-2 text-left text-sm text-[var(--black)] hover:bg-[var(--gray-l)]"><Trophy className="h-4 w-4" />Scout ao vivo</Link>
                            <Link href={buildAdminGamePath(game.id, 'stats', championshipId)} className="flex items-center gap-2 rounded-xl px-3 py-2 text-left text-sm text-[var(--black)] hover:bg-[var(--gray-l)]"><AlertTriangle className="h-4 w-4" />Stats do jogo</Link>
