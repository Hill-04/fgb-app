              ...
              <div className="mt-5">
                <TeamAthleteRequestForm
                  initialData={{
                    ...
                    // PM-06.N: novos campos (preservar no edit de rascunho)
                    sex: (athleteRequest as any).sex,
                    nationality: (athleteRequest as any).nationality,
                    maritalStatus: (athleteRequest as any).maritalStatus,
                    education: (athleteRequest as any).education,
                    cpf: (athleteRequest as any).cpf,
                    rg: (athleteRequest as any).rg,
                    rgOrgan: (athleteRequest as any).rgOrgan,
                    rgDate: (athleteRequest as any).rgDate?.toISOString().slice(0, 10) ?? null,
                    mobile: (athleteRequest as any).mobile,
                    fatherName: (athleteRequest as any).fatherName,
                    parentContactPhone: (athleteRequest as any).parentContactPhone,
                    parentContactRole: (athleteRequest as any).parentContactRole,
                    photoUrl: (athleteRequest as any).photoUrl,
                    docCPFFrontUrl: (athleteRequest as any).docCPFFrontUrl,
                    docCPFBackUrl: (athleteRequest as any).docCPFBackUrl,
                    docRGFrontUrl: (athleteRequest as any).docRGFrontUrl,
                    docRGBackUrl: (athleteRequest as any).docRGBackUrl,
                    docBirthCertUrl: (athleteRequest as any).docBirthCertUrl,
                    docOtherUrl: (athleteRequest as any).docOtherUrl,
                    cep: (athleteRequest as any).cep,
                    state: (athleteRequest as any).state,
                    city: (athleteRequest as any).city,
                    address: (athleteRequest as any).address,
                    addressNum: (athleteRequest as any).addressNum,
                    addressComp: (athleteRequest as any).addressComp,
                    position: (athleteRequest as any).position,
                    jerseyNumber: (athleteRequest as any).jerseyNumber,
                    height: (athleteRequest as any).height,
                    weight: (athleteRequest as any).weight,
