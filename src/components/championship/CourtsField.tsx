    ...
    <div className="space-y-4 p-6 bg-white/[0.02] border border-white/5 rounded-2xl transition-all hover:border-white/10 group">
      ...
      <div
        className={`rounded-xl px-4 py-3 text-xs flex items-start gap-3 transition-all duration-300 ${
          isParallel
            ? 'bg-fgb-green-500/10 text-fgb-green-400 border border-fgb-green-500/20'
            : 'bg-fgb-yellow-500/10 text-fgb-yellow-500 border border-fgb-yellow-500/20'
        }`}
      >
      ...
      {value > 4 && (
        <div className="flex items-center gap-2 text-[10px] text-fgb-yellow-500 font-bold uppercase tracking-widest bg-fgb-yellow-500/5 p-2 rounded-lg border border-fgb-yellow-500/10">
